...
public class ArrSum {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int size = MPI.COMM_WORLD.Size();	//No. of processes
        int unitsize = 5;	// 1 process is expected to handle 5 elements
        int root = 0;		
        ...
        if (rank == root) {			//inserting data in send buffer
        ...
        for (int i = 1; i < unitsize; i++) {		//calculate partial sums for each process
