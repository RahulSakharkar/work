 ...
 * 
 */
@WebServiceClient(name = "CalculatorWebService", targetNamespace = "http://myservice.com/", wsdlLocation = "http://localhost:8080/webservice_calculator/CalculatorWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORWEBSERVICE_QNAME = new QName("http://myservice.com/", "CalculatorWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/webservice_calculator/CalculatorWebService?wsdl");
    ...
    public CalculatorWebService getCalculatorWebServicePort() {
        return super.getPort(new QName("http://myservice.com/", "CalculatorWebServicePort"), CalculatorWebService.class);
    }
    ...
    public CalculatorWebService getCalculatorWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://myservice.com/", "CalculatorWebServicePort"), CalculatorWebService.class, features);
    }
