 ...
 * 
 */
@WebService(name = "CalculatorWebService", targetNamespace = "http://myservice.com/")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface CalculatorWebService {
    ...
    @Action(input = "http://myservice.com/CalculatorWebService/multiplicationRequest", output = "http://myservice.com/CalculatorWebService/multiplicationResponse")
    ...
    @Action(input = "http://myservice.com/CalculatorWebService/divisionRequest", output = "http://myservice.com/CalculatorWebService/divisionResponse")
    ...
    @Action(input = "http://myservice.com/CalculatorWebService/subtractionRequest", output = "http://myservice.com/CalculatorWebService/subtractionResponse")
    ...
    @Action(input = "http://myservice.com/CalculatorWebService/additionRequest", output = "http://myservice.com/CalculatorWebService/additionResponse")
